    ...
    try {
      if (hasFirebaseConfig && normalized.startsWith('T')) {
        try {
          ...
          // O código continua sendo a fonte segura de consulta quando a busca auxiliar não estiver disponível.
        }
      }
